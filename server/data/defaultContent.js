// Seed / fallback for admin-editable platform content.
//
// This is the single source of truth for the ministry's "static" information.
// On first boot `seedContent.js` copies each key into the `site_content`
// collection (only if missing — admin edits are never overwritten). The website
// and mobile app also bundle this shape as a fallback for when the API is
// unreachable.
//
// `icon` fields are semantic tokens; each client maps them to its own icon set
// (react-icons/fi on web, Ionicons on mobile).
...
const programs = [
  {
    ...
    description:
      'Evangelism, discipleship, counseling, and reintegration support for incarcerated people and those returning to their communities.',
    activities: [
      'Evangelism and Bible discipleship',
      'Professional counseling and trauma therapy',
      'Pre release life skills preparation',
      'Post release reintegration support',
      'Family reconciliation and mentorship',
    ],
  ...
  },
  {
    ...
    description:
      'Vocational skills, entrepreneurship, mentorship, and savings groups for single mothers and vulnerable women.',
    activities: [
  ...
  },
  {
    ...
    description:
      'Education assistance, child protection, mentoring, and spiritual nurture for vulnerable children and those born in prison.',
    activities: [
      'Education assistance and school fees support',
      'Child protection and safety programs',
      'After school mentoring and holiday programs',
  ...
  },
  {
    ...
    description:
      'Skills training, entrepreneurship, leadership development, and career guidance for unemployed and at risk youth.',
    activities: [
  ...
  },
  {
    ...
    description:
      'Marriage enrichment, parenting workshops, reconciliation, and counseling for families seeking restoration.',
    activities: [
  ...
  },
  {
    ...
    description:
      'Evangelism, relief assistance, health awareness, and development initiatives reaching underserved neighborhoods across Uganda.',
    activities: [
...
const leadership = {
  founder: {
    ...
    initials: 'FD',
    bio:
      'Visionary leader and founder of EECMI, called by God to serve the marginalized and forgotten. With a deep passion for prison ministry and community transformation, the Founder has built an organization that touches thousands of lives across Uganda.',
    responsibilities: [
...
const stories = [
  {
    ...
    story:
      'I entered prison a broken man. The EECMI team brought the Gospel to my cell. Three years after release I run a carpentry business, my family is restored, and I volunteer in the same prison that once held me.',
  },
  {
    name: 'Grace N.',
    ...
    story:
      'As a single mother of four I had no income and no hope. EECMI gave me tailoring skills, business training, and a savings group. Today I employ five other women in my community.',
  },
  {
    name: 'James O.',
    ...
    story:
      'I was an unemployed school dropout heading toward gang life. EECMI trained me in IT skills and helped me launch a tech repair business. Now I mentor twelve other youth.',
  },
  {
    name: 'Sarah & Peter K.',
    ...
    story:
      "Our marriage was on the verge of collapse. Through EECMI's retreats and counseling we found forgiveness and rebuilt trust. Our family is now a testimony of God's restoring power.",
  },
];
